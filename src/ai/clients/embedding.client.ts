...
// Korean text: ~1 char per token (each Korean character = 1 token)
const MAX_TOKENS = 8000; // Leave margin for safety
const MAX_TEXT_LENGTH = MAX_TOKENS; // 1:1 ratio for Korean
